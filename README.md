...
```bash
 curl -L https://github.com/hapi-server/server-nodejs/releases/download/v1.0.1/hapi-server-v1.0.1-darwin-x64.tgz | tar zxf -
 cd hapi-server-v1.0.1
 ./hapi-server --open
```
...
```bash
 curl -L https://github.com/hapi-server/server-nodejs/releases/download/v1.0.1/hapi-server-v1.0.1-linux-x64.tgz | tar zxf -
 cd hapi-server-v1.0.1
 ./hapi-server --open
```
...
```bash
 curl -L https://github.com/hapi-server/server-nodejs/releases/download/v1.0.1/hapi-server-v1.0.1-linux-armv7l.tgz | tar zxf -
 cd hapi-server-v1.0.1
 ./hapi-server --open
```
...
```
docker pull rweigel/hapi-server:v1.0.1
docker run -dit --name hapi-server-v1.0.1 --expose 8999 -p 8999:8999 rweigel/hapi-server:v1.0.1
docker exec -it hapi-server-v1.0.1 ./hapi-server
