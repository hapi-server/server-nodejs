...
#
# Examples:
#   python Example.py --start 1970-01-01T00:00:00.000000Z --stop 1970-01-01T00:10:00.000000Z
#   python Example.py --fmt binary --start 1970-01-01T00:00:00.000000Z --stop 1970-01-01T00:10:00.000000Z
#   python Example.py --params Time --start 1970-01-01T00:00:00.000000Z --stop 1970-01-01T00:10:00.000000Z
#   python Example.py --params Time,vector --start 1970-01-01T00:00:00.000000Z --stop 1970-01-01T00:10:00.000000Z
...
if v["error"] == "Code1ExitBeforeDataSent":
  import time
  time.sleep(1)
  sys.stderr.write("1501, Could not connect to server.");
  sys.exit(1)
...
for i in range(0,mf-mo):
  ...
  if v["error"] == "Code1ExitAfterDataSent":
    sys.stdout.flush()
    sys.stderr.write("1501, Connection to upstream server ended unexpectedly.");
    sys.exit(1)
